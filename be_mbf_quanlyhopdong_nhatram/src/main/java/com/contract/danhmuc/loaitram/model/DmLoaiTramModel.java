package com.contract.danhmuc.loaitram.model;
...
@MappedSuperclass
public class DmLoaiTramModel extends AuditEntity<String> {
    public static DmLoaiTramModel fromEntity(DmLoaiTramEntity entity) {
