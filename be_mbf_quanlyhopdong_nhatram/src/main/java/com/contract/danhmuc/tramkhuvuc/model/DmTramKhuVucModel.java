package com.contract.danhmuc.tramkhuvuc.model;
...
@MappedSuperclass
@ToString
public class DmTramKhuVucModel extends AuditEntity<String> {
    public static DmTramKhuVucModel fromEntity(DmTramKhuVucEntity entity) {
