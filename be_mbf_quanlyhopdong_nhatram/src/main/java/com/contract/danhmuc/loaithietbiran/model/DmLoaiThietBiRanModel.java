package com.contract.danhmuc.loaithietbiran.model;
...
@MappedSuperclass
public class DmLoaiThietBiRanModel extends AuditEntity<String> {
    public static DmLoaiThietBiRanModel fromEntity(DmLoaiThietBiRanEntity entity) {
